...
import static lab.mars.MCRRTImp.base.MathUtilityKt.epsilonEquals;
...
public class TestVector2 {
    ...
    public void testDistance() {
        ...
        assert epsilonEquals(result, Math.sqrt(2));
    }
    ...
    public void testDot() {
        ...
        assert epsilonEquals(result, 2 * 3 + 5 * 7);
    }
    ...
    public void testAngle() {
        ...
        System.out.println(result);
        assert epsilonEquals(result, 30);
    }
    ...
    public void testRotate() {
        ...
        assert epsilonEquals(v2.x(), Math.cos(Math.PI / 6));
        assert epsilonEquals(v2.y(), Math.sin(Math.PI / 6));
    }
    ...
    public void testLerp() {
        ...
        System.out.println(v2);
        assert epsilonEquals(v1.x(), 1) && epsilonEquals(v1.y(), 1.5);
    }
}
