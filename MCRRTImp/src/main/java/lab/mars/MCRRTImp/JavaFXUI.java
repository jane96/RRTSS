...
//
//
//    public void drawTarget(Attacker attacker, Pencil pencil) {
//        DimensionalWayPoint target = attacker.target();
//        pencil.filled().color(Color.YELLOWGREEN).circle(target.origin, target.radius);
//    }
//
//    public void drawUAV(Attacker attacker, Pencil pencil) {
...
//    }
//
//    public void drawPath(Attacker attacker,  Pencil pencil) {
...
//            int counter = 0;
//            for (DimensionalWayPoint wayPoint2D : path) {
...
//    }
//
//    public void drawGrid(Attacker attacker, Pencil pencil) {
//        ScaledGrid gridWorld = attacker.gridWorld();
//        DimensionalPath<Cell2D> areaPath = attacker.areaPath();
//        if (gridWorld != null) {
...
//    }
//
//    private Attacker leftUpAttacker() {
//        Vector2 attackerPosition = new Vector2(5, 5);
//        Vector2 targetPosition = new Vector2(1900, 1900);
//        Attacker attackerLeftUp = new Attacker(attackerPosition, new Vector2(1, 1).normalize().scale(4.1666667), 20, 30, 200, 50, 2);
//        DimensionalWayPoint target = new DimensionalWayPoint(targetPosition, 5, new Vector2(), 0);
//        attackerLeftUp.setDesignatedTarget(target);
//        return attackerLeftUp;
//    }
//
//    private Attacker middleLeftAttacker() {
...
//    }
//
//    private Attacker rightUpAttacker() {
...
//    }
//
//    private Attacker rightUpMiddleAttacker() {
...
//
//        List<CircleObstacle> circleObstacles = obstacleTestCase();
...
//        World.initialize(attackers, circleObstacles);
//    }
//
//    public JavaFXUI() {
//        buildWorld();
...
//        for (Attacker attacker : World.attacker()) {
