...
public class TestRRTSecondLayer {
    ...
    public void test(){
        ...
        WayPoint2D wp3 = new WayPoint2D(300.0, 300.0, 0, 0);
        WayPoint2D wp4 = new WayPoint2D(200.0, 200.0, 0, 0);
...
//        waypointList.add(wp4);
        ...
        RRTSecondLayer rrtSecondLayer = new RRTSecondLayer(attacker, 10, waypointList);
